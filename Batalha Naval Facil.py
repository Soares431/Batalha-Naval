...
print(f"X_1 {coordernada_X_1} Y_1 {coordernada_Y_1}")
print(f"X_2 {coordernada_X_2} Y_2 {coordernada_Y_2}")
print(f"X_3 {coordernada_X_3} Y_3 {coordernada_Y_3}")
print(f"X_4 {coordernada_X_4} Y_4 {coordernada_Y_4}")
